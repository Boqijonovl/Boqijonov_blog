...
async function makePage(blog, blogs) {
  ...
  if (previewBlog)
    previewBlogLink.href =
      "https://drew-boqijonovls-projects.vercel.app/blogDetail.html?id=" + previewBlog.id;
  ...
  if (upcomingBlog)
    upcomingBlogLink.href =
      "https://drew-boqijonovls-projects.vercel.app/blogDetail.html?id=" + upcomingBlog.id;
